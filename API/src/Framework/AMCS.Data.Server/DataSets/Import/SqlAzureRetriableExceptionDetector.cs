...
// Taken from https://github.com/aspnet/EntityFramework6/blob/master/src/EntityFramework.SqlServer/SqlAzureRetriableExceptionDetector.cs.
// See https://github.com/aspnet/EntityFramework6/blob/master/LICENSE.txt for the license associated with this code.
          ...
          foreach (SqlError err in sqlException.Errors)
          {
            switch (err.Number)
            {
              ...
              case -2:
                return true;
#if DEBUG
              // These are enabled to simplify debug testing. Just stopping the network interface
              // on the database will trigger these.
