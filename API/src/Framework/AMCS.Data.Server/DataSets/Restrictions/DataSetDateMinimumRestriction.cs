...
{
  public class DataSetDateMinimumRestriction : DataSetRestriction
  {
    public ZonedDateTime Value { get; }

    public DataSetDateMinimumRestriction(DataSetColumn column, ZonedDateTime value)
      : base(column)
    {
      Value = value;
    }
