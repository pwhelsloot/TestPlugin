...
import { DummyEditorDataWithOptionsService } from '@core-module/services/testing/api-editor-data-service/dummy-editor-data-with-options.service';
import { of, Subject } from 'rxjs';
import { takeUntil } from 'rxjs/operators';

describe('ApiBaseServiceWithOptions', () => {
  let service: DummyEditorDataWithOptionsService;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        DummyEditorDataWithOptionsService,
        {
    ...
    service = TestBed.inject(DummyEditorDataWithOptionsService);
  });
  ...
  it('get', fakeAsync(async () => {
    ...
    // Wait 1000 ticks here as debounceTime is 1000
    tick(1000);
  ...
  it('getArrayWithCount', fakeAsync(async () => {
    // Arrange
  ...
  it('postMessage', fakeAsync(async () => {
    // Arrange
