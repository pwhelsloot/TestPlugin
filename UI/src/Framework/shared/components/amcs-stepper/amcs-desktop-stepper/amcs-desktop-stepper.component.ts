...
@Component({
  selector: 'app-amcs-desktop-stepper',
  templateUrl: './amcs-desktop-stepper.component.html',
  styleUrls: ['./amcs-desktop-stepper.component.scss'],
...
export class AmcsDesktopStepperComponent extends AutomationLocatorDirective {
